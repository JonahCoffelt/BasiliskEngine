...
from scripts.physics_handler import PhysicsHandler
...
class ProjectHandler:
    ...
    def update(self, delta_time:float) -> None:
        self.current_project.update(delta_time)
...
class Project:
    ...
    def __init__(self, engine) -> None:
        ...
        self.physics_handler = PhysicsHandler(self.current_scene)
    ...
    def release(self) -> None:
        ...
        """
        [scene.release() for scene in self.scenes.values()] # for scene in self.scenes.values(): scene.release() ???
...
class BlankProject(Project):
    def __init__(self, engine) -> None:
        ...
        # update scene to physics handler
        self.physics_handler.scene = self.current_scene
